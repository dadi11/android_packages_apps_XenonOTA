    ...
    private void clickDownload(){
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String URL = "https://github.com/opengapps/"+c_u+"/releases/download/"+date+"/open_gapps-"+c_u+"-"+a_v+"-"+v_r+"-"+date+".zip";

                Downloader downloader = new Downloader(MainActivity.getActivity(), URL);
